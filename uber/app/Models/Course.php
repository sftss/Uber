...
class Course extends Model
{
    ...
    protected $fillable = [
        'id_course','id_chauffeur','id_velo','id_lieu_depart','id_lieu_arrivee','id_client','prix_reservation','date_prise_en_charge','duree_course','heure_arrivee','terminee',"acceptee","validationclient","validationchauffeur","pourboire","est_facture",
    ];
