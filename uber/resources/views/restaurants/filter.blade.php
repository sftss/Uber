...
<div id="fond"
    style="background-image: url('https://www.comeindubai.com/wp-content/uploads/2021/04/fast-food-dubai-scaled.jpeg'); background-size: cover; background-position: center center;">
    ...
    <form action="{{ route('restaurants.search') }}" method="GET" class="filter-form">
        ...
        <div class="form-group-restau">
            ...
            <input type="text" id="lieu" name="lieu" class="form-input"
                placeholder="Lyon, Annecy, Quick, ..." value="{{ request('lieu', '') }}">
        </div>
        ...
        <input type="hidden" id="horaire-selected" name="horaire-selected"
            value="{{ request('horaire-selected', '') }}">
