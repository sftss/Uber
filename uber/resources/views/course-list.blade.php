    ...
    @foreach ($courses as $course)
        <div class="course_container pageClient">
            ...
            <ul class="course_details">
                <li class="chauffeur">
                    @if ($course->chauffeur)
                        Chauffeur : {{ $course->chauffeur->prenom_chauffeur }} {{ $course->chauffeur->nom_chauffeur }}
                    @else
                        Vélo : {{ $course->id_velo }}
                    @endif
                </li>
                ...
                <li class="arrivee">Lieu d'arrivée : {{ $course->lieuArrivee->rue }} {{ $course->lieuArrivee->cp }}
