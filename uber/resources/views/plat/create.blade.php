...
<div class="container">
    ...
    <form id="formCreateProduit" action="{{ route('plat.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" placeholder="Entrer le nom de votre produit" class="form-control" id="libelle_plat"
                name="libelle_plat" value="{{ old('libelle_plat') }}" required>
        </div>

        <div class="form-group">
            <label for="prix_plat">Prix du plat :</label>
            <input type="number" style="width:15%" step="0.1" value=0 min=0 max=100 class="form-control" id="prix_plat"
        ...
        <div class="form-group">
            ...
            <input
                ...
                type="text" class="form-control" id="photo_plat" name="photo_plat" value="{{ old('photo_plat') }}"
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const urlInput = document.getElementById('photo_plat');
