...
<div class="container">
    <h2 style="text-align: center; margin: 3% 0;">Ajouter un produit pour le lieu de vente</h2>
    <form id="formCreateProduit" action="{{ route('lieux.produit.store', $lieu_id) }}" method="POST">
        @csrf
        ...
        <div class="form-group">
            ...
            <input style="width:15%" type="number" min=0 value=0 step="1" id="prix_produit" name="prix_produit"
                required>
        </div>

        <div class="form-group">
            <label for="photo_produit">URL de l'image :</label>
            <input
                ...
                type="text" class="form-control" id="photo_produit" name="photo_produit" placeholder="Entrer une URL"
                value="{{ old('photo_produit') }}" required>
        </div>
