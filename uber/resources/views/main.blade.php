...
<main>
        <section class="suggestions">
            ...
            <div class="card">
                ...
                <div class="content">
                    <h3>Course</h3>
                    <p>Allez où vous voulez avec Uber. Commandez une course en un clic et c'est parti !</p>
            ...
            <div class="card">
                ...
                <div class="content">
                    <h3>Deux-roues</h3>
                    <p>Vous pouvez désormais trouver et louer un vélo électrique via l'application Uber.</p>
                    <a href="#" class="details">Détails</a>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="content">
                    <h3>Réserver</h3>
                    <p>Réservez votre course à l'avance pour pouvoir vous détendre le jour même.</p>
                    <a href="#" class="details">Détails</a>
                </div>
            </div>
    ...
    <section class="features">
        <div class="container">
            ...
            <div class="links-grid">
                ...
                <a href="{{ url('/restaurants/catPrestationSearch') }}" class="feature-link">Rechercher une prestation</a>
            </div>
        </div>
    </section>
</main>
