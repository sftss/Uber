    ...
    <header class="header" id="header">
        <nav class="navbar">
            ...
            <div class="navbar-links">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/chauffeur-propositions/7') }}">Commandes à livrer</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/professionnel-creation/restaurant/12') }}">Livraisons Urgentes</a>
                    </li>
                    <li class="nav-item">
