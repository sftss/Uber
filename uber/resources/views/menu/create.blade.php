...
<div class="container">
    ...
    <form id="formCreateProduit" action="{{ route('menu.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" placeholder="Entrer le nom de votre produit" class="form-control" id="libelle_menu"
                name="libelle_menu" value="{{ old('libelle_menu') }}" required>
        </div>

        <div class="form-group">
            <label for="prix_menu">Prix du menu</label>
            <input style="width:15%" type="number" step="1" value=0 min=0 class="form-control" id="prix_menu"
        ...
        <div class="form-group">
            ...
            <input placeholder="Entrer le nom de votre plat" type="text" class="form-control" id="plat1"
                name="plat1" value="{{ old('plat1') }}" required>
        </div>

        <div class="form-group">
            <label for="prixplat1">Prix Plat 1</label>
            <input style="width:15%" step="1" value=0 min=0 type="number" class="form-control" id="prixplat1"
                name="prixplat1" value="{{ old('prixplat1') }}">
        </div>
        ...
        <div class="form-group">
            ...
            <input
                style="font-family: Arial, sans-serif; border: 1px solid #ccc; border-radius: 5px; padding: 0.5rem; font-size: 1rem; outline: none; transition: border-color 0.3s;"
                placeholder="Entrer une URL" type="text" class="form-control" id="photoplat1" name="photoplat1"
                value="{{ old('photoplat1') }}" required>
        </div>
