...
<div class="container">
    ...
    <form id="formCreateProduit" action="{{ route('menu.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input style="width:15%" type="number" value="0" max=100 step="0.01" min="3"
                class="form-control" id="prix_menu" name="prix_menu" value="{{ old('prix_menu') }}" required>
            @error('prix_menu')
                <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <select id="plat_selection" name="plat_selection" class="form-control"
                        onchange="togglePlatFields(this)">
                ...
                <div class="plat-fields-container">
                    ...
                    <div id="nouveau_plat_fields" class="mb-3" style="display: none;">
                        <div class="mb-3">
                            ...
                            <input type="text" name="plat_nom" id="plat_nom" class="form-control"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="plat_prix" id="plat_prix" class="form-control"
                                placeholder="Entrer le prix du plat" step="0.01" min="0">
                            @error('plat_prix')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="plat_photo" id="plat_photo" class="form-control"
                                placeholder="Entrer une URL de la photo">
                            @error('plat_photo')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div style="display: flex;align-items:baseline;gap:5px">
                                ...
                                <div class="info-bubble" onclick="toggleInfo(this)">
                                    ...
                                    <div class="info-content">
                                        Ceci est la liste de plats déjà vendus par votre établissement, s'il n'y en a
                                        aucun vous pouvez en ajouter un en même temps que le menu !
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <select id="produit_selection" name="produit_selection" class="form-control"
                        onchange="toggleProduitFields(this)">
                ...
                <div class="produit-fields-container">
                    ...
                    <div id="nouveau_produit_fields" class="mb-3" style="display: none;">
                        <div class="mb-3">
                            ...
                            <input type="text" name="produit_nom" id="produit_nom" class="form-control"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="produit_prix" id="produit_prix" class="form-control"
                                placeholder="Entrer le prix du produit" step="0.01" min="0">
                            @error('produit_prix')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="produit_photo" id="produit_photo" class="form-control"
                                placeholder="Entrer une URL de la photo">
                            @error('produit_photo')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                    ...
                    <div id="produit_existant_fields" class="mb-3" style="display: none;">
                        <div class="mb-3">
                            <div style="display: flex;align-items:baseline;gap:5px">
                                ...
                                <div class="info-bubble" onclick="toggleInfo(this)">
                                    ?
                                    <div class="info-content">
                                        Ceci est la liste de produits déjà vendus par votre établissement, s'il n'y en a
                                        aucun vous pouvez en ajouter un en même temps que le menu !
                                    </div>
                                </div>
                            </div>
                        ...
                        <select name="produit_existant" id="produit_existant" class="form-control">
                            ...
                            @foreach ($produits as $produit)
                                <option value="{{ $produit->id_produit }}">{{ $produit->nom_produit }}
                                </option>
                            @endforeach
